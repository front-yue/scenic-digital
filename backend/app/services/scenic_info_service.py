        ...
        try:
            with connection.cursor() as cursor:
                sql = """
                    ...
                    (scenic_name, scenic_en_name, cover_image, weather_temp, weather_desc, introduction, ticket_price, opening_hours)
    ...
    def update_info(self, info_id, data):
        ...
        try:
            with connection.cursor() as cursor:
                fields = []
                values = []
                allowed_keys = ['scenic_name', 'scenic_en_name', 'cover_image', 'weather_temp', 'weather_desc', 'introduction', 'ticket_price', 'opening_hours']
